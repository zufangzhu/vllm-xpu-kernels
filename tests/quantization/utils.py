...
class XPUWoqActQuantMode(IntEnum):
    ...
    For symmetric quantization,
        activation is quantized to int8 with zero point 0; otherwise uint8
    with non-zero zp.
    -----------------------------------------
...
VLLM_ACT_QUANT_MODE_TO_XPU = {
    WoqActQuantMode.NONE:
    XPUWoqActQuantMode.UNQUANT_A,
    WoqActQuantMode.PER_TENSOR:
    XPUWoqActQuantMode.QUANT_A_PER_TENSOR,
    WoqActQuantMode.PER_TENSOR_SYM:
    XPUWoqActQuantMode.QUANT_A_PER_TENSOR_SYM,
    ...
    WoqActQuantMode.PER_IC_BLOCK:
    XPUWoqActQuantMode.QUANT_A_PER_K_BLOCK,
    WoqActQuantMode.PER_IC_BLOCK_SYM:
    XPUWoqActQuantMode.QUANT_A_PER_K_BLOCK_SYM,
    WoqActQuantMode.PER_BATCH_IC_BLOCK:
    XPUWoqActQuantMode.QUANT_A_PER_M_K_BLOCK,
    WoqActQuantMode.PER_BATCH_IC_BLOCK_SYM:
    XPUWoqActQuantMode.QUANT_A_PER_M_K_BLOCK_SYM,
}
